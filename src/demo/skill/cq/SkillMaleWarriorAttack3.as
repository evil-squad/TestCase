package demo.skill.cq {
	 ...
	 */
	public class SkillMaleWarriorAttack3 extends SkillBase {
		
		private var _effect : Particle3D;
		
		public function SkillMaleWarriorAttack3() {
			super();
			_skillDetail = _skillManager.getSkillInfo(SkillDefineEnum.SKILL_CQ_MALE_WARRIOR_SKILL_3);
		}
		
		override protected function castSkill():void {
			super.castSkill();
			
			var effect:String = _skillManager.getSkillPath("efc_liehuodaofa");
