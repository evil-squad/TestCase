package demo.skill.cq {
	 ...
	 */
	public class SkillMaleWarriorAttack1 extends SkillBase {
		
		private var _effect : Particle3D;
		
		public function SkillMaleWarriorAttack1() {
			super();
		...
		override protected function castSkill():void {
			...
			var effect:String = _skillManager.getSkillPath("efc_banyuewandao");
