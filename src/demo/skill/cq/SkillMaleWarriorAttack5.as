package demo.skill.cq {
	 ...
	 */
	public class SkillMaleWarriorAttack5 extends SkillBase {
		
		private var _effect : Particle3D;
		
		public function SkillMaleWarriorAttack5() {
			super();
		...
		override protected function castSkill():void {
			...
			var effect:String = _skillManager.getSkillPath("efc_shizihou");
			...
			var total:uint = _caster.animationController.getSequenceDuration(PlayerAnimationController.SEQ_ATTACK_250);
