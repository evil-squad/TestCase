package demo.skill.cq {
	 ...
	 */
	public class SkillMaleWarriorAttack2 extends SkillBase {
		
		private var _effect : Particle3D;
		
		public function SkillMaleWarriorAttack2() {
			super();
			_skillDetail = _skillManager.getSkillInfo(SkillDefineEnum.SKILL_CQ_MALE_WARRIOR_SKILL_2);
		}
		
		override protected function castSkill():void {
			super.castSkill();
			
			var effect:String = _skillManager.getSkillPath("efc_cishajianshu");
