package demo.skill.cq {
	 ...
	 */
	public class SkillMaleMageAttack2 extends SkillBase {
		
		private var _effect : Particle3D;
		
		public function SkillMaleMageAttack2() {
			super();
		...
		override protected function castSkill():void {
			...
			var effect:String = _skillManager.getSkillPath("efc_jiguangdianying");
