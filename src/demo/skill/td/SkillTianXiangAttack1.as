package demo.skill.td {
	...
	public class SkillTianXiangAttack1 extends SkillBase {
		
		private var _effect : Particle3D;
		
		public function SkillTianXiangAttack1() {
			super();
			_skillDetail = _skillManager.getSkillInfo(SkillDefineEnum.SKILL_TD_TIAN_XIANG_SKILL_1);
		}
		
		override protected function castSkill():void {
			super.castSkill();
			
			var effect:String = _skillManager.getSkillPath("fx_210");
