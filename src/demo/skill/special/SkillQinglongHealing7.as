package demo.skill.special
{
	...
	public class SkillQinglongHealing7 extends SkillBase
	{
		private var _animationName:String;
		private var _effect:Particle3D;
		public function SkillQinglongHealing7()
		{
			super();
			_skillDetail = _skillManager.getSkillInfo(SkillDefineEnum.SKILL_QINGLONG_SKILL_7);
		}
