package
{
	...
	public class WCTest extends ExampleTemplate
	{
...
class SceneLoader extends ObjectContainer3D
{
	...
	public function SceneLoader(url:String)
	{
		...
		addLoaderEvents();
		_loader.load(new URLRequest(url), null, null, new AWD2Parser());
	}
		...
		if (e.type == AssetEvent.ASSET_COMPLETE)
		{
			...
			switch (e.asset.assetType)
			{
				...
				case AssetType.DISTRICT:
					var district:DistrictWithPath = obj as DistrictWithPath;
					district.generateNavMesh(null);
					break;
